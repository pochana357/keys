...
<div
  class="fixed top-0 left-0 z-30 flex h-full w-full flex-col items-center justify-center gap-2 text-lg font-bold"
>
  <div class="bg-surface-950 w-80 text-center">
