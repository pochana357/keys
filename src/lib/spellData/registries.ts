import { defensiveBuff, defensiveExtended, type SpellDict } from './types';

export const offensiveSpells: SpellDict = {
  ...
  // 1217607: { effect: [] }, // Void Metamorphosis (Devourer) is currently bugged in WCL and does not appear in cast logs.
...
export const defensiveSpells: SpellDict = {
  // Priest
  ...
  12: {
    selfCastOnly: true,
    effect: [defensiveBuff(400126), defensiveBuff(433749)],
  }, // Regrowth (Forestwalk, Protective Growth)
...
export const defensiveSpelllikeBuffs: SpellDict = {
  65116: { effect: [defensiveBuff(65116)] }, // Stoneform
};

export const offensiveSpelllikeBuffs: SpellDict = {
